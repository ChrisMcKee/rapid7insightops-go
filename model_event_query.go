...
type EventQuery struct {
	...
	// Information about the KVPs in the log entry that were parsed when they were received.
	KvpInfo []KvpInfoInner `json:"kvp_info,omitempty"`
}
...
// GetKvpInfo returns the KvpInfo field value if set, zero value otherwise.
func (o *EventQuery) GetKvpInfo() []KvpInfoInner {
	if o == nil || IsNil(o.KvpInfo) {
		var ret []KvpInfoInner
		return ret
	}
	return o.KvpInfo
}

// GetKvpInfoOk returns a tuple with the KvpInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EventQuery) GetKvpInfoOk() ([]KvpInfoInner, bool) {
	if o == nil || IsNil(o.KvpInfo) {
		return nil, false
	}
	return o.KvpInfo, true
}
...
// SetKvpInfo gets a reference to the given []KvpInfoInner and assigns it to the KvpInfo field.
...
func (o EventQuery) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.KvpInfo) {
		toSerialize["kvp_info"] = o.KvpInfo
	}
