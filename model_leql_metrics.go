...
// checks if the LeqlMetrics type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LeqlMetrics{}

// LeqlMetrics The LEQL statement of the pre-computed query.
type LeqlMetrics struct {
...
func (o LeqlMetrics) MarshalJSON() ([]byte, error) {
...
func (o LeqlMetrics) ToMap() (map[string]interface{}, error) {
...
type NullableLeqlMetrics struct {
	value *LeqlMetrics
	isSet bool
}

func (v NullableLeqlMetrics) Get() *LeqlMetrics {
	return v.value
}

func (v *NullableLeqlMetrics) Set(val *LeqlMetrics) {
	v.value = val
	v.isSet = true
}

func (v NullableLeqlMetrics) IsSet() bool {
	return v.isSet
}

func (v *NullableLeqlMetrics) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLeqlMetrics(val *LeqlMetrics) *NullableLeqlMetrics {
	return &NullableLeqlMetrics{value: val, isSet: true}
}

func (v NullableLeqlMetrics) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLeqlMetrics) UnmarshalJSON(src []byte) error {
	v.isSet = true
