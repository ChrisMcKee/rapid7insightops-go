...
// TargetResponseParamsSet - The list of key values that are defined depending on the notification target type.
type TargetResponseParamsSet struct {
...
// TargetParamsSetIconworkflowAsTargetResponseParamsSet is a convenience function that returns TargetParamsSetIconworkflow wrapped in TargetResponseParamsSet
func TargetParamsSetIconworkflowAsTargetResponseParamsSet(v *TargetParamsSetIconworkflow) TargetResponseParamsSet {
	return TargetResponseParamsSet{
		TargetParamsSetIconworkflow: v,
	}
}

// TargetParamsSetMailtoAsTargetResponseParamsSet is a convenience function that returns TargetParamsSetMailto wrapped in TargetResponseParamsSet
func TargetParamsSetMailtoAsTargetResponseParamsSet(v *TargetParamsSetMailto) TargetResponseParamsSet {
	return TargetResponseParamsSet{
		TargetParamsSetMailto: v,
	}
}

// TargetParamsSetPagerdutyAsTargetResponseParamsSet is a convenience function that returns TargetParamsSetPagerduty wrapped in TargetResponseParamsSet
func TargetParamsSetPagerdutyAsTargetResponseParamsSet(v *TargetParamsSetPagerduty) TargetResponseParamsSet {
	return TargetResponseParamsSet{
		TargetParamsSetPagerduty: v,
	}
}

// TargetParamsSetSlackAsTargetResponseParamsSet is a convenience function that returns TargetParamsSetSlack wrapped in TargetResponseParamsSet
func TargetParamsSetSlackAsTargetResponseParamsSet(v *TargetParamsSetSlack) TargetResponseParamsSet {
	return TargetResponseParamsSet{
		TargetParamsSetSlack: v,
	}
}

// TargetParamsSetSqsAsTargetResponseParamsSet is a convenience function that returns TargetParamsSetSqs wrapped in TargetResponseParamsSet
func TargetParamsSetSqsAsTargetResponseParamsSet(v *TargetParamsSetSqs) TargetResponseParamsSet {
	return TargetResponseParamsSet{
		TargetParamsSetSqs: v,
	}
}

// TargetParamsSetWebhookAsTargetResponseParamsSet is a convenience function that returns TargetParamsSetWebhook wrapped in TargetResponseParamsSet
func TargetParamsSetWebhookAsTargetResponseParamsSet(v *TargetParamsSetWebhook) TargetResponseParamsSet {
	return TargetResponseParamsSet{
...
func (dst *TargetResponseParamsSet) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(TargetResponseParamsSet)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(TargetResponseParamsSet)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src TargetResponseParamsSet) MarshalJSON() ([]byte, error) {
...
func (obj *TargetResponseParamsSet) GetActualInstance() interface{} {
	if obj == nil {
		return nil
	}
...
type NullableTargetResponseParamsSet struct {
	value *TargetResponseParamsSet
	isSet bool
}

func (v NullableTargetResponseParamsSet) Get() *TargetResponseParamsSet {
	return v.value
}

func (v *NullableTargetResponseParamsSet) Set(val *TargetResponseParamsSet) {
	v.value = val
	v.isSet = true
}

func (v NullableTargetResponseParamsSet) IsSet() bool {
	return v.isSet
}

func (v *NullableTargetResponseParamsSet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTargetResponseParamsSet(val *TargetResponseParamsSet) *NullableTargetResponseParamsSet {
	return &NullableTargetResponseParamsSet{value: val, isSet: true}
}

func (v NullableTargetResponseParamsSet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTargetResponseParamsSet) UnmarshalJSON(src []byte) error {
	v.isSet = true
