...
// checks if the LeqlPATCH type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LeqlPATCH{}

// LeqlPATCH The LEQL statement of the query and/or the time range.
type LeqlPATCH struct {
	During *LeqlPATCHDuring `json:"during,omitempty"`
...
// SetDuring gets a reference to the given LeqlPATCHDuring and assigns it to the During field.
...
func (o LeqlPATCH) MarshalJSON() ([]byte, error) {
...
func (o LeqlPATCH) ToMap() (map[string]interface{}, error) {
...
type NullableLeqlPATCH struct {
	value *LeqlPATCH
	isSet bool
}

func (v NullableLeqlPATCH) Get() *LeqlPATCH {
	return v.value
}

func (v *NullableLeqlPATCH) Set(val *LeqlPATCH) {
	v.value = val
	v.isSet = true
}

func (v NullableLeqlPATCH) IsSet() bool {
	return v.isSet
}

func (v *NullableLeqlPATCH) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLeqlPATCH(val *LeqlPATCH) *NullableLeqlPATCH {
	return &NullableLeqlPATCH{value: val, isSet: true}
}

func (v NullableLeqlPATCH) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLeqlPATCH) UnmarshalJSON(src []byte) error {
	v.isSet = true
